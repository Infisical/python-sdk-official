...
class ApiV1OrganizationOrganizationIdIncidentContactOrgGet200Response(BaseModel):
    ...
    """
    incident_contacts_org: conlist(ApiV1OrganizationOrganizationIdIncidentContactOrgGet200ResponseIncidentContactsOrgInner) = Field(default=..., alias="incidentContactsOrg")
