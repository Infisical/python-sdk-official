...
import infisicalapi_client.models
from infisicalapi_client import rest
from infisicalapi_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(infisicalapi_client.models, klass)
