...
from infisicalapi_client.models.api_v1_workspace_project_slug_roles_post_request import ApiV1WorkspaceProjectSlugRolesPostRequest  # noqa: E501

class TestApiV1WorkspaceProjectSlugRolesPostRequest(unittest.TestCase):
    """ApiV1WorkspaceProjectSlugRolesPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1WorkspaceProjectSlugRolesPostRequest:
        """Test ApiV1WorkspaceProjectSlugRolesPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1WorkspaceProjectSlugRolesPostRequest`
        """
        model = ApiV1WorkspaceProjectSlugRolesPostRequest()  # noqa: E501
        if include_optional:
            return ApiV1WorkspaceProjectSlugRolesPostRequest(
                slug = '0',
                name = '0',
                description = '',
                permissions = [
    ...
    def testApiV1WorkspaceProjectSlugRolesPostRequest(self):
        """Test ApiV1WorkspaceProjectSlugRolesPostRequest"""
