...
from infisicalapi_client.models.api_v1_secret_rotations_restart_post200_response import ApiV1SecretRotationsRestartPost200Response  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ApiV1SecretRotationsRestartPost200Response:
        ...
        if include_optional:
            return ApiV1SecretRotationsRestartPost200Response(
                secret_rotation = infisicalapi_client.models._api_v1_secret_rotations_restart_post_200_response_secret_rotation._api_v1_secret_rotations_restart_post_200_response_secretRotation(
                    id = '', 
                    provider = '', 
                    secret_path = '', 
                    interval = 1.337, 
