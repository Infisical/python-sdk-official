...
from infisicalapi_client.models.api_v1_additional_privilege_identity_temporary_post_request import ApiV1AdditionalPrivilegeIdentityTemporaryPostRequest  # noqa: E501

class TestApiV1AdditionalPrivilegeIdentityTemporaryPostRequest(unittest.TestCase):
    """ApiV1AdditionalPrivilegeIdentityTemporaryPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1AdditionalPrivilegeIdentityTemporaryPostRequest:
        """Test ApiV1AdditionalPrivilegeIdentityTemporaryPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1AdditionalPrivilegeIdentityTemporaryPostRequest`
        """
        model = ApiV1AdditionalPrivilegeIdentityTemporaryPostRequest()  # noqa: E501
        if include_optional:
            return ApiV1AdditionalPrivilegeIdentityTemporaryPostRequest(
                identity_id = '0',
                project_slug = '0',
                slug = '0',
                permissions = [
    ...
    def testApiV1AdditionalPrivilegeIdentityTemporaryPostRequest(self):
        """Test ApiV1AdditionalPrivilegeIdentityTemporaryPostRequest"""
